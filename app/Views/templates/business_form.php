...
<form id="business_form" class="flex flex-col gap-5" action="POST" aria-label="Business Form">
    ...
    <div class="flex flex-col gap-2">
        ...
        <input 
            ...
            name="name" 
            id="name" 
            class="p-2 rounded-lg readonly:" 
            placeholder="Enter your business name" 
            value="<?= isset($business) ? esc($business['name']) : "" ?>" 
    ...
    <div class="flex flex-col gap-2">
        ...
        <input 
            ...
            required 
            value="<?= isset($business) ? esc($business['table_num']) : "" ?>" 
            <?= isset($business) ? 'disabled' : '' ?> 
    ...
    <div class="flex flex-col gap-2">
        ...
        <input 
            ...
            id="logo" 
            name="logo" 
            class="file-input file-input-bordered file-input-accent w-full max-w-xs file-input-sm lg:file-input-md" 
            <?= isset($business) ? 'disabled' : '' ?> 
    ...
    <div class="flex flex-col gap-2">
        ...
        <input 
            ...
            required 
            value="<?= isset($business) ? esc($business['address']) : "" ?>" 
            <?= isset($business) ? 'disabled' : '' ?> 
    ...
    <div class="flex flex-col gap-2">
        ...
        <input 
            ...
            required 
            value="<?= isset($business) ? esc($business['weekday_hours']) : "" ?>" 
            <?= isset($business) ? 'disabled' : '' ?> 
    ...
    <div class="flex flex-col gap-2">
        ...
        <input 
            ...
            placeholder="HH:mm-HH:mm" 
            required 
            value="<?= isset($business) ? esc($business['weekend_hours']) : "" ?>" 
            <?= isset($business) ? 'disabled' : '' ?> 
            aria-label="Weekend Working Hours">
    </div>
