...
<?= $this->section('content'); ?>
    <section class="flex flex-row w-4/6 m-auto items-center">
        ...
        <section class="lg:w-1/2 flex flex-col w-full">
            ...
            <form method="POST" class="flex flex-col gap-5 lg:w-1/2 lg:m-auto">
                <div class="flex flex-col gap-2">
                    <label for="username">Username</label>
                    <input type="text" name="username" id="username" class="p-2 rounded-lg" placeholder="Enter your username">
                </div>
                <div class="flex flex-col gap-2">
                    <label for="password">Password</label>
                    <input type="password" name="password" id="password" class="p-2 rounded-lg" placeholder="Enter your password">
                </div>
                <div class="flex flex-col">
                    <input type="button" class="p-2 btn btn-accent" value="Sign In">
                    <div class="mt-4">
